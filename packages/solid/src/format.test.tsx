...
describe("formatElements", function () {
  ...
  it("should format unpaired elements", function () {
    expect(html(() => formatElements("<0/>", { 0: () => <br /> }))).toEqual(
      "<br>",
    )
  })
    ...
    expect(
      html(() =>
        formatElements("<0>Inner</0>", {
          0: (props) => <strong>{props.children}</strong>,
        }),
      ),
    ...
    expect(
      html(() =>
        formatElements("<0>About</0>", {
          0: (props) => <a href="/about">{props.children}</a>,
        }),
      ),
    ...
    expect(
      html(() =>
        formatElements("<named>About</named>", {
          named: (props) => <a href="/about">{props.children}</a>,
        }),
      ),
    ).toEqual('<a href="/about">About</a>')
  })
    ...
    expect(
      html(() =>
        formatElements("<named>About <b>us</b></named>", {
          named: (props) => <a href="/about">{props.children}</a>,
          b: (props) => <strong>{props.children}</strong>,
        }),
      ),
    ...
    expect(
      html(() =>
        formatElements("<0><1>Deep</1></0>", {
          0: (props) => <a href="/about">{props.children}</a>,
          1: (props) => <strong>{props.children}</strong>,
        }),
      ),
    ...
    expect(
      html(() =>
        formatElements("text<named/>", {
          named: (props) => <span>{props.children}</span>,
        }),
      ),
    ).toEqual("text<span></span>")
  })
