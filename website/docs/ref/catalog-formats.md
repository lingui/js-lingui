...
| `foldLength`                  | number                          | `0`     | Maximum line width before folding long strings. When a string exceeds this length, it will be split across multiple lines. Set to `0` to disable folding (strings will only break on actual newlines)                                                               |
...
| `foldLength`           | number  | `0`            | Maximum line width before folding long strings. When a string exceeds this length, it will be split across multiple lines. Set to `0` to disable folding                 |
