...
Lingui needs a transpiler to work. It's responsible for transforming Lingui's JS/JSX components into [ICU Message Format](/docs/guides/message-format.md) and extracting message IDs. Both Babel and SWC transpilers are supported. Follow the Babel or SWC setup depending on what transpiler your project already uses.
...
1.  Follow the [Choosing Transpiler](#choosing-a-transpiler) instructions.
