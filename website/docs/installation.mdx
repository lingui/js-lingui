...
Lingui supports Vite with a dedicated plugin [`@lingui/vite-plugin`](/docs/ref/vite-plugin.md). The Lingui Vite integration supports both [`@vitejs/plugin-react`](https://www.npmjs.com/package/@vitejs/plugin-react) and [`@vitejs/plugin-react-swc`](https://www.npmjs.com/package/@vitejs/plugin-react-swc) and compiles `.po` message catalogs on the fly.
...
1.  Follow the [Babel Setup](/installation?transpiler=babel#choosing-transpiler) instructions.
...
1.  Follow the [SWC Setup](/installation?transpiler=swc#choosing-transpiler) instructions.
