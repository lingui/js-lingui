...
![Scheme of discovering by glob pattern](../assets/extractor-glob-scheme.jpg#gh-light-mode-only)
![Scheme of discovering by glob pattern](../assets/extractor-glob-scheme-dark.jpg#gh-dark-mode-only)
...
![Scheme of discovering by dependencies](../assets/extractor-deps-scheme.jpg#gh-light-mode-only)
![Scheme of discovering by dependencies](../assets/extractor-deps-scheme-dark.jpg#gh-dark-mode-only)
