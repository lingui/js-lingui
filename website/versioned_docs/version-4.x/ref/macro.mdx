...
**JSX macros** are transformed to [`Trans`](../ref/react.md#trans) component from [`@lingui/react`](../ref/react.md):
...
**JS macros** (i.e. macros that looks like a simple JavaScript functions) are transformed into [`i18n._`](../ref/core.md#i18n._) call.
...
:::note
By default, the `i18n` object is imported from `@lingui/core`. If you use a custom instance of `i18n` object, you need to set [`runtimeConfigModule`](../ref/conf.md#runtimeconfigmodule) or pass a custom instance to [`t`](../ref/macro.mdx#t).
:::

The only exception is [`defineMessage`](../ref/macro.mdx#definemessage) which is transformed into message descriptor. In other words, the message isn't translated directly and can be used anytime later:
...
These macros can be used in any context (e.g. outside JSX). All JS macros are transformed into a _Message Descriptor_ wrapped inside of [`i18n._`](../ref/core.md#i18n._) call.

:::note
By default, the `i18n` object is imported from `@lingui/core`. If you use a custom instance of `i18n` object, you need to set [`runtimeConfigModule`](../ref/conf.md#runtimeconfigmodule) or pass a custom instance to [`t`](../ref/macro.mdx#t).
:::

_Message Descriptor_ is an object with message ID, default message and other parameters. [`i18n._`](../ref/core.md#i18n._) accepts message descriptors and performs translation and formatting:
...
If you need to add variables to plural form, you can use template string literals. This time [`t`](../ref/macro.mdx#t) macro isn't required as template strings are transformed automatically:
...
[`Trans`](../ref/react.md#trans) is the basic macro for static messages, messages with variables, but also for messages with inline markup:
...
Render prop function used to render translation. This prop is directly passed to [`Trans`](../ref/react.md#trans) component from [`@lingui/react`](../ref/react.md). See [rendering of translations](../ref/react.md#rendering-translations) for more info.
...
Props of [`Plural`](../ref/macro.mdx#plural-1) macro are transformed into [`plural`](../guides/message-format.md) format.
